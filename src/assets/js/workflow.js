...
var getBalanceData = (tradeSymbol) => {
  ...
  const endPointUrl = 'https://wqm7ry2q3k.execute-api.ap-south-1.amazonaws.com/dev/api/binance/v1/balance'; //FIXME: no hard coding
  //'http://localhost:3010/api/binance/v1/balance'
